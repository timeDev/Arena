define(['vendor/cannon', 'console', 'input', 'keycode', 'Stats', 'settings', 'scene-manager', 'level', 'player', 'SeXHR', 'commands'],
    function (CANNON, console, input, keycode, Stats, settings, scenemgr, level, player, Sexhr, commands) {
        "use strict";
        var paused = true,
            // Functions
            update, showDebugGrid, init,
            // Internal
